...
class GenresControl: UIStackView,  UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    private func setupGenres() {
        ...
        let label = UILabel()
        label.widthAnchor.constraint(equalToConstant: Constants.labelGenresWidth).isActive = true
